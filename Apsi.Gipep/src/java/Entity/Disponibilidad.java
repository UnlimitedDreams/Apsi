...
public class Disponibilidad  implements java.io.Serializable {
    ...
    public Disponibilidad(BigDecimal codDis, Date fechaInicial, Date fechaFinal, BigDecimal rango, BigDecimal numHoras, BigDecimal periodo, String estado, Long horasCumplidas, Set asesorias, Set dispoUsuarios, Set nivelDisponibles, Set festivoses, Set dias) {
       this.codDis = codDis;
       this.fechaInicial = fechaInicial;
       this.fechaFinal = fechaFinal;
       this.rango = rango;
