...
//        this.dia = dia;
//    }
    public MDias(boolean estado, String dia, String hora_inicio, String hora_final) {
        this.estado = estado;
        this.dia = dia;
    ...
    public MDias(int cod, String fecha1, String fecha2, String hora_inicio, String hora_final,String razon) {
        this.cod = cod;
        this.fecha1 = fecha1;
        this.fecha2 = fecha2;
        this.hora_inicio = hora_inicio;
