...
HttpSession sesion = request.getSession();
      ...
      out.write("                        <h2>Breve descripci&oacute;n</h2>\r\n");
      ...
      out.write("                                    <a href=\"logIn.jsp\" class=\"btn btn-light\">Accede</a>\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <div class=\"col-md-3 col-sm-6\">\r\n");
      out.write("                                <div class=\"service-item\">\r\n");
      ...
      out.write("                                    </h4>\r\n");
      out.write("                                    <p>La &uacute;nica forma de acceder a esta herramienta es que estes registrado. H&aacute;slo pronto!.</p>\r\n");
      ...
      out.write("        ");
            ...
            try {
                int nolog = Integer.parseInt(sesion.getAttribute("nolog").toString());
                System.out.print(nolog);
                        
                
                if (nolog == 2) {
                    out.print("<script>alert('Usuario y / o contraseña no válido')</script>");
                }
            } catch (java.lang.NullPointerException e) {
