    ...
    <body>
        ...
        <div id="layout-principal" class="layout layout-principal">
            ...
            <form class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
                <div class="title">
                    <h2>Informaci&oacute;n personal</h2></div>
                <div class="element-name">
                    <label class="title">Nombres</label><br>
                    <span class="nameFirst">
                        <input placeholder="Nombres" type="text" size="8" name="name[first]" />
                        <span class="icon-place"></span>
                    </span>
                    <span class="nameLast">
                        <input placeholder="Apellidos" type="text" size="14" name="name[last]" />
                        <span class="icon-place"></span>
                    </span>
                </div>
                <div class="element-date">
                    <label class="title">Fecha del ultimo ingreso</label>
                    <div class="item-cont">
                        <input class="large" data-format="yyyy-mm-dd" type="date" name="date" placeholder="Último ingreso" readonly/>
                        <span class="icon-place"></span>
                    </div>
                </div>
                <div class="element-address">
                    ...
                    <span class="addr1">
                        <input placeholder="Street Address" type="text" name="address[addr1]" />
                        <span class="icon-place"></span>
                    </span>
                    <span class="addr2">
                        <input placeholder="Address Line 2" type="text" name="address[addr2]" />
                        <span class="icon-place"></span>
                    </span>
                    <span class="city">
